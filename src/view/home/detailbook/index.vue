<template>
  <div class="goods">
    ...
    <van-goods-action>
      <van-goods-action-icon icon="chat-o" @click="toServe">
        客服
      </van-goods-action-icon>
      <van-goods-action-icon icon="cart-o" @click="toCart" :info="(cartInfo > 0) ? cartInfo : ''">
        购物车
      </van-goods-action-icon>
      <van-goods-action-button type="warning" @click="skuClick">
        加入购物车
      </van-goods-action-button>
      <van-goods-action-button type="danger" @click="skuClick">
        立即购买
      </van-goods-action-button>
    </van-goods-action>
...
import { booklist, itemordersave } from '@/api/mall'
